...
<table id="lz_form_<!--name-->" class="lz_input">
	<tr>
		<td><input name="form_<!--name-->" type="text" placeholder="<!--caption_plain-->" class="lz_form_base lz_form_box" maxlength="254" onchange="parent.lz_chat_save_input_value('<!--name-->',this.value);" onkeyup="return parent.lz_chat_save_input_value('<!--name-->',this.value);"></td>
