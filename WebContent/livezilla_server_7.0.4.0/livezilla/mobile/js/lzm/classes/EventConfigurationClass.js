...
EventConfiguration.prototype.showEventConfiguration = function() {
    ...
    lzm_commonDialog.CreateDialogWindow(headerString, bodyString, footerString, 'flash', 'event-configuration', 'event-configuration', 'ec-close-btn', false);
...
EventConfiguration.prototype.showEventCreationForm = function(type,id){
    ...
    lzm_commonDialog.CreateDialogWindow(headerString, bodyString, footerString, 'flash', 'edit-event'+id, 'edit-event'+id, 'cancel-event', false);
    ...
    $('#cancel-event').click(function() {
        TaskBarManager.RemoveActiveWindow();
        TaskBarManager.GetWindow('event-configuration').Maximize();
    });
