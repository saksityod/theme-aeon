function AdminUserManagementClass() {
    ...
    this.newOpPerms = '2121202101000210111101111111111111011111011011022';
...
AdminUserManagementClass.prototype.createListView = function(uid, gid, tab) {
    ...
    var panelHtml = lzm_inputControls.createButton('umg-new-btn', '', 'showCreateButtonMenu(event)', t('New'), '<i class="fa fa-plus"></i>', 'lr', {}, t('Create new operator'),30, 'd') +
        lzm_inputControls.createButton('umg-edit-btn', disabledClass, 'editListObject(null)', tid('edit'), '<i class="fa fa-edit"></i>', 'lr', {'margin-left': '4px'}, t('Edit the selected operator'), 30,'d') +
        lzm_inputControls.createButton('umg-rm-btn', disabledClass, 'removeListObject(null)', t('Remove'), '<i class="fa fa-remove"></i>', 'lr', {'margin-left': '4px'}, t('Remove the selected operator'), 30,'d');
    ...
    switch(tab) {
        case 'text~welcome':
            ...
            tabContent = that.createTextEmailsTabContent([
                ...
                {type: 'textarea', size: 'a', id: 'text-welcmb', label: t('Welcome Message for Instant Callback Chats <!--html_enabled-->',[['<!--html_enabled-->', htmlEnabled]]), info: '', value: 'welcmb'}
            ], textAndEmails);
            break;
        case 'text~invite':
...
AdminUserManagementClass.prototype.createSignatureContextMenuHtml = function() {
    ...
    contextMenuHtml += '<div onclick="addPlaceholder(\'signature\', \'%operator_name%\');">' +
        '<span id="sig-add-op-name" class="cm-line cm-click">' + t('Operator Name') + '</span></div>';
